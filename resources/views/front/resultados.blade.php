            ...
            <div class="box-filtrar-t">
              ...
              <ul class="list-filter">
                @for ($i = 0; $i < count($estados); $i++)
                  ...
                  <li><a href="javascript:void(0)"  onclick="addFilter('{{ str_slug($estados[$i]['estado'],"-") }}','estado')">{{ $estados[$i]['estado'] }}</a> <span class="cantidad-filter">({{ $estados[$i]['cantidad'] }})</span></li>
            ...
            <div class="box-filtrar-t">
              ...
              <ul class="list-filter">
                @for ($i = 0; $i < count($ciudades); $i++)
                  ...
                  <li><a href="javascript:void(0)"  onclick="addFilter('{{ str_slug($ciudades[$i]['ciudad'],"-") }}','ciudad')">{{ $ciudades[$i]['ciudad'] }}</a> <span class="cantidad-filter">({{ $ciudades[$i]['cantidad'] }})</span></li>
