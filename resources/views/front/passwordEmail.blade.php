  ...
  <body class="hold-transition login-page" style="background-image:url(http://i.imgur.com/is7VvUY.png);background-image:url(http://i.imgur.com/lhK6EAu.png);">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <p class="login-box-msg" style="font-size: 20px; font-weight: bold;">Enlace de recuperación</p>
        <p>Ingresa tu dirección de correo y te enviaremos un enlace para restablecer tu password</p>
